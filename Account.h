...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// username_box
			// 
			this->username_box->Location = System::Drawing::Point(828, 284);
			this->username_box->Name = L"username_box";
			this->username_box->Size = System::Drawing::Size(409, 20);
			this->username_box->TabIndex = 5;
			// 
			// pass_box
			// 
			this->pass_box->Location = System::Drawing::Point(828, 399);
			this->pass_box->Name = L"pass_box";
			this->pass_box->Size = System::Drawing::Size(409, 20);
			this->pass_box->TabIndex = 6;
			// 
			// Income_box
			// 
			this->Income_box->Location = System::Drawing::Point(828, 506);
			this->Income_box->Name = L"Income_box";
			this->Income_box->Size = System::Drawing::Size(409, 20);
			...
			this->account_button->Location = System::Drawing::Point(975, 558);
			...
			this->login_link->Location = System::Drawing::Point(1134, 613);
			this->login_link->Name = L"login_link";
			this->login_link->Size = System::Drawing::Size(67, 24);
			...
			this->ClientSize = System::Drawing::Size(1322, 664);
