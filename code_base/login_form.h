...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->username_box->Location = System::Drawing::Point(145, 310);
			this->username_box->Name = L"username_box";
			this->username_box->Size = System::Drawing::Size(278, 38);
			this->username_box->TabIndex = 3;
			// 
			// password_box
			// 
			this->password_box->ForeColor = System::Drawing::SystemColors::InactiveCaptionText;
			this->password_box->Location = System::Drawing::Point(145, 413);
			this->password_box->Name = L"password_box";
			this->password_box->PasswordChar = '*';
			this->password_box->Size = System::Drawing::Size(278, 38);
			...
			this->login_button->Location = System::Drawing::Point(198, 473);
